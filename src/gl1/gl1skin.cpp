...
skinOpen(void *o, int32, int32)
{
 ...
 return nullptr;
#endif // PGM_PIPELINE 
	skinGlobals.pipelines[PLATFORM_GL1] = makeSkinPipeline();
...
skinClose(void *o, int32, int32)
{
 ...
 return nullptr;
#endif // PGM_PIPELINE 
	((ObjPipeline*)skinGlobals.pipelines[PLATFORM_GL1])->destroy();
	skinGlobals.pipelines[PLATFORM_GL1] = nil;
...
initSkin(void)
{
 ...
 return;
	...
	Driver::registerPlugin(PLATFORM_GL1, 0, ID_SKIN,
	                       skinOpen, skinClose);
}
