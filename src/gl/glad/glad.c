...
static void* myLoad(GLADloadproc load, const char* proc)
{
	void* res = load(proc);
	printf("[KFX] myLoad '%s': %p\n", proc, res);
	return res;
}

static void load_GL_1_Extensions(GLADloadproc load) {
	printf("[KFX] load_GL_1_Extensions\n");
	if (GLVersion.major != 1)
	{
		printf("[KFX] - GLVersion.major = %i != 1, not needed\n", GLVersion.major);
		return;
	}

	// glad_glBlendEquationSeparate = (PFNGLBLENDEQUATIONSEPARATEPROC)myLoad(load, "glBlendEquationSeparate");
	// glad_glDrawBuffers = (PFNGLDRAWBUFFERSPROC)myLoad(load, "glDrawBuffers");
	// glad_glStencilOpSeparate = (PFNGLSTENCILOPSEPARATEPROC)myLoad(load, "glStencilOpSeparate");
	// glad_glStencilFuncSeparate = (PFNGLSTENCILFUNCSEPARATEPROC)myLoad(load, "glStencilFuncSeparate");
	// glad_glStencilMaskSeparate = (PFNGLSTENCILMASKSEPARATEPROC)myLoad(load, "glStencilMaskSeparate");
	glad_glAttachShader = (PFNGLATTACHSHADERPROC)myLoad(load, "glAttachShader");
	glad_glBindAttribLocation = (PFNGLBINDATTRIBLOCATIONPROC)myLoad(load, "glBindAttribLocation");
	glad_glCompileShader = (PFNGLCOMPILESHADERPROC)myLoad(load, "glCompileShader");
	glad_glCreateProgram = (PFNGLCREATEPROGRAMPROC)myLoad(load, "glCreateProgram");
	glad_glCreateShader = (PFNGLCREATESHADERPROC)myLoad(load, "glCreateShader");
	glad_glDeleteProgram = (PFNGLDELETEPROGRAMPROC)myLoad(load, "glDeleteProgram");
	glad_glDeleteShader = (PFNGLDELETESHADERPROC)myLoad(load, "glDeleteShader");
	// glad_glDetachShader = (PFNGLDETACHSHADERPROC)myLoad(load, "glDetachShader");
	glad_glDisableVertexAttribArray = (PFNGLDISABLEVERTEXATTRIBARRAYPROC)myLoad(load, "glDisableVertexAttribArray");
	glad_glEnableVertexAttribArray = (PFNGLENABLEVERTEXATTRIBARRAYPROC)myLoad(load, "glEnableVertexAttribArray");
	// glad_glGetActiveAttrib = (PFNGLGETACTIVEATTRIBPROC)myLoad(load, "glGetActiveAttrib");
	// glad_glGetActiveUniform = (PFNGLGETACTIVEUNIFORMPROC)myLoad(load, "glGetActiveUniform");
	// glad_glGetAttachedShaders = (PFNGLGETATTACHEDSHADERSPROC)myLoad(load, "glGetAttachedShaders");
	// glad_glGetAttribLocation = (PFNGLGETATTRIBLOCATIONPROC)myLoad(load, "glGetAttribLocation");
	glad_glGetProgramiv = (PFNGLGETPROGRAMIVPROC)myLoad(load, "glGetProgramiv");
	glad_glGetProgramInfoLog = (PFNGLGETPROGRAMINFOLOGPROC)myLoad(load, "glGetProgramInfoLog");
	glad_glGetShaderiv = (PFNGLGETSHADERIVPROC)myLoad(load, "glGetShaderiv");
	glad_glGetShaderInfoLog = (PFNGLGETSHADERINFOLOGPROC)myLoad(load, "glGetShaderInfoLog");
	// glad_glGetShaderSource = (PFNGLGETSHADERSOURCEPROC)myLoad(load, "glGetShaderSource");
	glad_glGetUniformLocation = (PFNGLGETUNIFORMLOCATIONPROC)myLoad(load, "glGetUniformLocation");
	// glad_glGetUniformfv = (PFNGLGETUNIFORMFVPROC)myLoad(load, "glGetUniformfv");
	// glad_glGetUniformiv = (PFNGLGETUNIFORMIVPROC)myLoad(load, "glGetUniformiv");
	// glad_glGetVertexAttribdv = (PFNGLGETVERTEXATTRIBDVPROC)myLoad(load, "glGetVertexAttribdv");
	// glad_glGetVertexAttribfv = (PFNGLGETVERTEXATTRIBFVPROC)myLoad(load, "glGetVertexAttribfv");
	// glad_glGetVertexAttribiv = (PFNGLGETVERTEXATTRIBIVPROC)myLoad(load, "glGetVertexAttribiv");
	// glad_glGetVertexAttribPointerv = (PFNGLGETVERTEXATTRIBPOINTERVPROC)myLoad(load, "glGetVertexAttribPointerv");
	// glad_glIsProgram = (PFNGLISPROGRAMPROC)myLoad(load, "glIsProgram");
	// glad_glIsShader = (PFNGLISSHADERPROC)myLoad(load, "glIsShader");
	glad_glLinkProgram = (PFNGLLINKPROGRAMPROC)myLoad(load, "glLinkProgram");
	glad_glShaderSource = (PFNGLSHADERSOURCEPROC)myLoad(load, "glShaderSource");
	glad_glUseProgram = (PFNGLUSEPROGRAMPROC)myLoad(load, "glUseProgram");
	// glad_glUniform1f = (PFNGLUNIFORM1FPROC)myLoad(load, "glUniform1f");
	// glad_glUniform2f = (PFNGLUNIFORM2FPROC)myLoad(load, "glUniform2f");
	// glad_glUniform3f = (PFNGLUNIFORM3FPROC)myLoad(load, "glUniform3f");
	// glad_glUniform4f = (PFNGLUNIFORM4FPROC)myLoad(load, "glUniform4f");
	glad_glUniform1i = (PFNGLUNIFORM1IPROC)myLoad(load, "glUniform1i");
	// glad_glUniform2i = (PFNGLUNIFORM2IPROC)myLoad(load, "glUniform2i");
	// glad_glUniform3i = (PFNGLUNIFORM3IPROC)myLoad(load, "glUniform3i");
	// glad_glUniform4i = (PFNGLUNIFORM4IPROC)myLoad(load, "glUniform4i");
	// glad_glUniform1fv = (PFNGLUNIFORM1FVPROC)myLoad(load, "glUniform1fv");
	// glad_glUniform2fv = (PFNGLUNIFORM2FVPROC)myLoad(load, "glUniform2fv");
	// glad_glUniform3fv = (PFNGLUNIFORM3FVPROC)myLoad(load, "glUniform3fv");
	glad_glUniform4fv = (PFNGLUNIFORM4FVPROC)myLoad(load, "glUniform4fv");
	// glad_glUniform1iv = (PFNGLUNIFORM1IVPROC)myLoad(load, "glUniform1iv");
	// glad_glUniform2iv = (PFNGLUNIFORM2IVPROC)myLoad(load, "glUniform2iv");
	// glad_glUniform3iv = (PFNGLUNIFORM3IVPROC)myLoad(load, "glUniform3iv");
	glad_glUniform4iv = (PFNGLUNIFORM4IVPROC)myLoad(load, "glUniform4iv");
	// glad_glUniformMatrix2fv = (PFNGLUNIFORMMATRIX2FVPROC)myLoad(load, "glUniformMatrix2fv");
	// glad_glUniformMatrix3fv = (PFNGLUNIFORMMATRIX3FVPROC)myLoad(load, "glUniformMatrix3fv");
	glad_glUniformMatrix4fv = (PFNGLUNIFORMMATRIX4FVPROC)myLoad(load, "glUniformMatrix4fv");
	// glad_glValidateProgram = (PFNGLVALIDATEPROGRAMPROC)myLoad(load, "glValidateProgram");
	// glad_glVertexAttrib1d = (PFNGLVERTEXATTRIB1DPROC)myLoad(load, "glVertexAttrib1d");
	// glad_glVertexAttrib1dv = (PFNGLVERTEXATTRIB1DVPROC)myLoad(load, "glVertexAttrib1dv");
	// glad_glVertexAttrib1f = (PFNGLVERTEXATTRIB1FPROC)myLoad(load, "glVertexAttrib1f");
	// glad_glVertexAttrib1fv = (PFNGLVERTEXATTRIB1FVPROC)myLoad(load, "glVertexAttrib1fv");
	// glad_glVertexAttrib1s = (PFNGLVERTEXATTRIB1SPROC)myLoad(load, "glVertexAttrib1s");
	// glad_glVertexAttrib1sv = (PFNGLVERTEXATTRIB1SVPROC)myLoad(load, "glVertexAttrib1sv");
	// glad_glVertexAttrib2d = (PFNGLVERTEXATTRIB2DPROC)myLoad(load, "glVertexAttrib2d");
	// glad_glVertexAttrib2dv = (PFNGLVERTEXATTRIB2DVPROC)myLoad(load, "glVertexAttrib2dv");
	// glad_glVertexAttrib2f = (PFNGLVERTEXATTRIB2FPROC)myLoad(load, "glVertexAttrib2f");
	// glad_glVertexAttrib2fv = (PFNGLVERTEXATTRIB2FVPROC)myLoad(load, "glVertexAttrib2fv");
	// glad_glVertexAttrib2s = (PFNGLVERTEXATTRIB2SPROC)myLoad(load, "glVertexAttrib2s");
	// glad_glVertexAttrib2sv = (PFNGLVERTEXATTRIB2SVPROC)myLoad(load, "glVertexAttrib2sv");
	// glad_glVertexAttrib3d = (PFNGLVERTEXATTRIB3DPROC)myLoad(load, "glVertexAttrib3d");
	// glad_glVertexAttrib3dv = (PFNGLVERTEXATTRIB3DVPROC)myLoad(load, "glVertexAttrib3dv");
	// glad_glVertexAttrib3f = (PFNGLVERTEXATTRIB3FPROC)myLoad(load, "glVertexAttrib3f");
	// glad_glVertexAttrib3fv = (PFNGLVERTEXATTRIB3FVPROC)myLoad(load, "glVertexAttrib3fv");
	// glad_glVertexAttrib3s = (PFNGLVERTEXATTRIB3SPROC)myLoad(load, "glVertexAttrib3s");
	// glad_glVertexAttrib3sv = (PFNGLVERTEXATTRIB3SVPROC)myLoad(load, "glVertexAttrib3sv");
	// glad_glVertexAttrib4Nbv = (PFNGLVERTEXATTRIB4NBVPROC)myLoad(load, "glVertexAttrib4Nbv");
	// glad_glVertexAttrib4Niv = (PFNGLVERTEXATTRIB4NIVPROC)myLoad(load, "glVertexAttrib4Niv");
	// glad_glVertexAttrib4Nsv = (PFNGLVERTEXATTRIB4NSVPROC)myLoad(load, "glVertexAttrib4Nsv");
	// glad_glVertexAttrib4Nub = (PFNGLVERTEXATTRIB4NUBPROC)myLoad(load, "glVertexAttrib4Nub");
	// glad_glVertexAttrib4Nubv = (PFNGLVERTEXATTRIB4NUBVPROC)myLoad(load, "glVertexAttrib4Nubv");
	// glad_glVertexAttrib4Nuiv = (PFNGLVERTEXATTRIB4NUIVPROC)myLoad(load, "glVertexAttrib4Nuiv");
	// glad_glVertexAttrib4Nusv = (PFNGLVERTEXATTRIB4NUSVPROC)myLoad(load, "glVertexAttrib4Nusv");
	// glad_glVertexAttrib4bv = (PFNGLVERTEXATTRIB4BVPROC)myLoad(load, "glVertexAttrib4bv");
	// glad_glVertexAttrib4d = (PFNGLVERTEXATTRIB4DPROC)myLoad(load, "glVertexAttrib4d");
	// glad_glVertexAttrib4dv = (PFNGLVERTEXATTRIB4DVPROC)myLoad(load, "glVertexAttrib4dv");
	// glad_glVertexAttrib4f = (PFNGLVERTEXATTRIB4FPROC)myLoad(load, "glVertexAttrib4f");
	// glad_glVertexAttrib4fv = (PFNGLVERTEXATTRIB4FVPROC)myLoad(load, "glVertexAttrib4fv");
	// glad_glVertexAttrib4iv = (PFNGLVERTEXATTRIB4IVPROC)myLoad(load, "glVertexAttrib4iv");
	// glad_glVertexAttrib4s = (PFNGLVERTEXATTRIB4SPROC)myLoad(load, "glVertexAttrib4s");
	// glad_glVertexAttrib4sv = (PFNGLVERTEXATTRIB4SVPROC)myLoad(load, "glVertexAttrib4sv");
	// glad_glVertexAttrib4ubv = (PFNGLVERTEXATTRIB4UBVPROC)myLoad(load, "glVertexAttrib4ubv");
	// glad_glVertexAttrib4uiv = (PFNGLVERTEXATTRIB4UIVPROC)myLoad(load, "glVertexAttrib4uiv");
	// glad_glVertexAttrib4usv = (PFNGLVERTEXATTRIB4USVPROC)myLoad(load, "glVertexAttrib4usv");
	glad_glVertexAttribPointer = (PFNGLVERTEXATTRIBPOINTERPROC)myLoad(load, "glVertexAttribPointer");
}
